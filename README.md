...
Create entry for Bäckerei Kohlmann:
```shell
curl --header "Content-Type: application/json" --request POST --data '{"name":"Bäckerei Kohlmann","description":"Walk
ing distance to Zentralmensa","type":"BAKERY","campus":"INF","street":"Im Neuenheimer Feld","houseNumber":"370","postalCode":69120,"city":"Heidelberg"}' http://localhost:8080/api/pos
```

Check if new POS was created:
```shell
